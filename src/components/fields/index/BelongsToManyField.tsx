 ...
 */
interface BelongsToManyIndexFieldProps {
    field: FieldData;
    record: Record<string, any>;
}

/**
 * BelongsToManyIndexField - BelongsToMany field için index sayfası component'ı
 *
 * Bu component, BelongsToMany ilişkisini index sayfasında görüntüler.
 ...
 * ```
 */
export function BelongsToManyIndexField({ field, record }: BelongsToManyIndexFieldProps) {
